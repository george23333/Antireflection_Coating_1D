...
def main():
    ...
    plt.figure(figsize=(6, 5))
    plt.plot(x, np.real(E), label="Re{E(x)}")
    plt.axvline(0.0, linestyle=":", label="x=0")
    plt.axvline(d, linestyle=":", label="x=d")
    plt.xlabel("x [m]")
    plt.ylabel(r"$\mathrm{Re}\{E(x)\}$ [V/m]")
    #plt.title("Reference Solution: Real Part of Electric Field")
    plt.title("(a)")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.figure(figsize=(6, 5))
    plt.plot(x, np.imag(E), label="Im{E(x)}")
    plt.axvline(0.0, linestyle=":", label="x=0")
    plt.axvline(d, linestyle=":", label="x=d")
    plt.xlabel("x [m]")
    plt.ylabel(r"$\mathrm{Im}\{E(x)\}$ [V/m]")
    #lt.title("Reference Solution: Imaginary Part of Electric Field")
    plt.title("(b)")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
